...
<div class="toast-etiqueta" id="toast">
    <div class="icono">&#10003;</div>
    <div>
        <div class="titulo">Cliente registrado</div>
    ...
    <form action="guardar_cliente.php" method="POST">
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <div class="ayuda mt-1">Ingresa el número de teléfono del cliente.</div>
        </div>

        <div class="mb-3">
            <label for="correo" class="form-label">Correo del Cliente</label>
            <input type="email" id="correo" name="correo" class="form-control"
                   placeholder="Ej. cliente@ejemplo.com" required>
            <div class="ayuda mt-1">Ingresa el correo electrónico del cliente.</div>
        </div>

        <div class="linea-punteada"></div>

        <button type="submit" class="btn btn-registrar form-control">Registrar cliente</button>
    </form>
</div>
